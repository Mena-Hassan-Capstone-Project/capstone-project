  ...
  return (
    ...
    <div className="interests" id="interests">
        ...
        <div className="column col-2" >
          ...
          {
            userInfo.interests && userInfo.interests.movies  && Array.isArray(userInfo.interests.movies)?
        ...
        {/* TV Shows */}
          ...
          {
            userInfo.interests && userInfo.interests.shows && Array.isArray(userInfo.interests.shows)?
        ...
        }
        {
          ...
          {
            userInfo.interests && userInfo.interests.hobbies && Array.isArray(userInfo.interests.hobbies)?
